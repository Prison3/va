...
public class IWebViewUpdateServiceProxy extends ClassInvocationStub {
    public static final String TAG = IWebViewUpdateServiceProxy.class.getSimpleName();
    ...
    public static class GetCurrentWebViewPackage extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewUpdateService: getCurrentWebViewPackage called");
            
            try {
                // Try to get the current WebView package from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewUpdateService: Successfully got current WebView package");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewUpdateService: Failed to get current WebView package", e);
            }
            
            // Return null to let the system use the default WebView provider
            Logger.d(TAG, "WebViewUpdateService: Returning null to use system default");
            return null;
        }
    }
    ...
    public static class GetValidWebViewPackages extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewUpdateService: getValidWebViewPackages called");
            ...
            try {
                ...
                if (result != null && result instanceof PackageInfo[]) {
                    ...
                    if (packages.length > 0) {
                        Logger.d(TAG, "WebViewUpdateService: Found " + packages.length + " valid WebView packages");
                        return result;
                    }
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewUpdateService: Failed to get valid WebView packages", e);
            }
            
            // Return empty array to prevent WebView provider conflicts
            Logger.d(TAG, "WebViewUpdateService: Returning empty array to prevent conflicts");
    ...
    public static class IsMultiProcessEnabled extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewUpdateService: isMultiProcessEnabled called, returning true");
            return true;
        }
    }
    ...
    public static class GetWebViewPackages extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewUpdateService: getWebViewPackages called");
            
            try {
                // Try to get WebView packages from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewUpdateService: Successfully got WebView packages");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewUpdateService: Failed to get WebView packages", e);
            }
    ...
    public static class GetWebViewProviderInfo extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewUpdateService: getWebViewProviderInfo called");
            
            try {
                // Try to get WebView provider info from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewUpdateService: Successfully got WebView provider info");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewUpdateService: Failed to get WebView provider info", e);
            }
    ...
    public static class IsWebViewPackage extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (args != null && args.length > 0) {
                ...
                Logger.d(TAG, "WebViewUpdateService: isWebViewPackage called for: " + packageName);
                
                // Check if it's a known WebView package
                if (isKnownWebViewPackage(packageName)) {
                    Logger.d(TAG, "WebViewUpdateService: " + packageName + " is a known WebView package");
                    return true;
                }
            }
            ...
            try {
                ...
                Logger.w(TAG, "WebViewUpdateService: Failed to check WebView package", e);
                return false;
            }
        }
    ...
    public static class GetWebViewProvider extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewUpdateService: getWebViewProvider called");
            
            try {
                // Try to get WebView provider from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewUpdateService: Successfully got WebView provider");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewUpdateService: Failed to get WebView provider", e);
            }
    ...
    public static class EnableWebViewPackage extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (args != null && args.length > 0) {
                String packageName = (String) args[0];
                Logger.d(TAG, "WebViewUpdateService: enableWebViewPackage called for: " + packageName);
            }
            
            try {
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "WebViewUpdateService: Failed to enable WebView package", e);
    ...
    public static class DisableWebViewPackage extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (args != null && args.length > 0) {
                String packageName = (String) args[0];
                Logger.d(TAG, "WebViewUpdateService: disableWebViewPackage called for: " + packageName);
            }
            
            try {
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "WebViewUpdateService: Failed to disable WebView package", e);
                // Return success to prevent crashes
                return true;
            }
        }
