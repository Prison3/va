package com.android.va.hook.miui;
...
public class IMiuiSecurityManagerProxy extends BinderInvocationStub {
    public static final String TAG = IMiuiSecurityManagerProxy.class.getSimpleName();
    ...
    protected Object getWho() {
        ...
        try {
            ...
            Logger.e(TAG, "Failed to get ISecurityManager interface: " + e.getMessage());
            return null;
        }
    }
    ...
    public static class SetAppPrivacyStatus extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Logger.d(TAG, "SetAppPrivacyStatus: Bypassing privacy status for " + packageName);
    ...
    public static class GetAppPrivacyStatus extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            String packageName = args.length > 0 ? (String) args[0] : "unknown";
            Logger.d(TAG, "GetAppPrivacyStatus: Returning default status for " + packageName);
    ...
    public static class SetAppPermissionControlOpen extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "SetAppPermissionControlOpen: Bypassing permission control setting");
            return true;
        }
    }
    ...
    public static class IsAppPermissionControlOpen extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "IsAppPermissionControlOpen: Returning false (disabled)");
    ...
    public static class SetWakeUpTime extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "SetWakeUpTime: Bypassing wake up time setting");
            return true;
        }
    }
    ...
    public static class GetWakeUpTime extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "GetWakeUpTime: Returning default wake up time");
    ...
    public static class SetTrackWakeUp extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "SetTrackWakeUp: Bypassing track wake up setting");
            return true;
        }
    }
    ...
    public static class IsTrackWakeUp extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "IsTrackWakeUp: Returning false (disabled)");
            return false;
        }
    }
    ...
    public static class SetGameMode extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "SetGameMode: Bypassing game mode setting");
            return true;
        }
    }
    ...
    public static class IsGameMode extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "IsGameMode: Returning false (not in game mode)");
            return false;
        }
    }
    ...
    public static class PushNewNotification extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "PushNewNotification: Bypassing notification push");
            return true;
        }
    }
    ...
    public static class SetAppRunningControlEnabled extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "SetAppRunningControlEnabled: Bypassing running control setting");
            return true;
        }
    }
    ...
    public static class GetAppRunningControlEnabled extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "GetAppRunningControlEnabled: Returning false (disabled)");
    ...
    public static class CheckAccessControl extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "CheckAccessControl: Allowing access");
    ...
    public static class SaveIcon extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "SaveIcon: Bypassing icon save");
            return true;
        }
    }
    ...
    public static class GetIcon extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "GetIcon: Returning null icon");
    ...
    public static class IsValidDevice extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "IsValidDevice: Returning true (valid device)");
    ...
    public static class ActuallyCheckPermission extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "ActuallyCheckPermission: Granting permission");
    ...
    public static class CheckSmsBlocked extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "CheckSmsBlocked: Returning false (not blocked)");
    ...
    public static class SetCurrentUserId extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "SetCurrentUserId: Bypassing user ID setting");
            return true;
        }
    }
    ...
    public static class GetCurrentUserId extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "GetCurrentUserId: Returning current user ID");
