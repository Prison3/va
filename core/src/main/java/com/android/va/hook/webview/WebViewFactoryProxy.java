...
public class WebViewFactoryProxy extends ClassInvocationStub {
    public static final String TAG = WebViewFactoryProxy.class.getSimpleName();
    ...
    public static class GetWebViewProviderClass extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewFactory: getWebViewProviderClass called");
            
            try {
                // Try to get the WebView provider class from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewFactory: Successfully got WebView provider class");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewFactory: Failed to get WebView provider class", e);
            }
            
            // Return the default WebView provider class
            try {
                Class<?> webViewClass = WebView.class;
                Logger.d(TAG, "WebViewFactory: Returning default WebView class: " + webViewClass.getName());
                return webViewClass;
            } catch (Exception e) {
                Logger.e(TAG, "WebViewFactory: Failed to get default WebView class", e);
                return null;
            }
        }
    }
    ...
    public static class GetWebViewProviderPackage extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewFactory: getWebViewProviderPackage called");
            
            try {
                // Try to get the WebView provider package from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewFactory: Successfully got WebView provider package");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewFactory: Failed to get WebView provider package", e);
            }
            
            // Return a default WebView package name
            String defaultPackage = "com.google.android.webview";
            Logger.d(TAG, "WebViewFactory: Returning default WebView package: " + defaultPackage);
    ...
    public static class GetWebViewProviderInfo extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewFactory: getWebViewProviderInfo called");
            
            try {
                // Try to get the WebView provider info from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewFactory: Successfully got WebView provider info");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewFactory: Failed to get WebView provider info", e);
            }
            
            // Return null to let the system use default
            Logger.d(TAG, "WebViewFactory: Returning null to use system default");
            return null;
        }
    }
    ...
    public static class IsWebViewSupported extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewFactory: isWebViewSupported called, returning true");
    ...
    public static class GetWebViewPackage extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewFactory: getWebViewPackage called");
            
            try {
                // Try to get the WebView package from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewFactory: Successfully got WebView package");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewFactory: Failed to get WebView package", e);
            }
    ...
    public static class GetWebViewProviderClassLoader extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewFactory: getWebViewProviderClassLoader called");
            
            try {
                // Try to get the WebView provider class loader from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewFactory: Successfully got WebView provider class loader");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewFactory: Failed to get WebView provider class loader", e);
            }
            
            // Return the current class loader as fallback
            try {
                ClassLoader classLoader = WebView.class.getClassLoader();
                Logger.d(TAG, "WebViewFactory: Returning current class loader: " + classLoader);
                return classLoader;
            } catch (Exception e) {
                Logger.e(TAG, "WebViewFactory: Failed to get current class loader", e);
                return null;
            }
        }
    }
    ...
    public static class GetWebViewProviderPackageInfo extends MethodHook {
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Logger.d(TAG, "WebViewFactory: getWebViewProviderPackageInfo called");
            
            try {
                // Try to get the WebView provider package info from the system
                Object result = method.invoke(who, args);
                if (result != null) {
                    Logger.d(TAG, "WebViewFactory: Successfully got WebView provider package info");
                    return result;
                }
            } catch (Exception e) {
                Logger.w(TAG, "WebViewFactory: Failed to get WebView provider package info", e);
            }
    ...
    public static class GetWebViewProviderClassWithPackage extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (args != null && args.length > 0) {
                ...
                Logger.d(TAG, "WebViewFactory: getWebViewProviderClass called for package: " + packageName);
            }
    ...
    public static class GetWebViewProviderClassLoaderWithPackage extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (args != null && args.length > 0) {
                String packageName = (String) args[0];
                Logger.d(TAG, "WebViewFactory: getWebViewProviderClassLoader called for package: " + packageName);
            }
