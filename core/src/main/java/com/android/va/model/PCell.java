...
/*
 * created by Prisoning at 2022/03/06
 * */
public class PCell implements Parcelable {
    /**
     * mnc : 1
     * lac : 41093
     * ci : 3865320
    ...
    public  PCell(){}
    public PCell(int MCC, int MNC, int LAC, int CID) {
    ...
    public static final Parcelable.Creator<PCell> CREATOR = new Parcelable.Creator<PCell>() {
        @Override
        public PCell createFromParcel(Parcel source) {
            return new PCell(source);
        }

        @Override
        public PCell[] newArray(int size) {
            return new PCell[size];
        }
    };
}
