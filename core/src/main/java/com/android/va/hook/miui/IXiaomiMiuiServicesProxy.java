...
import com.android.va.utils.XiaomiDeviceDetector;
...
public class IXiaomiMiuiServicesProxy extends ClassInvocationStub {
    public static final String TAG = IXiaomiMiuiServicesProxy.class.getSimpleName();
    ...
    protected void inject(Object base, Object proxy) {
        ...
        if (XiaomiDeviceDetector.isXiaomiDevice()) {
            Logger.d(TAG, "IXiaomiMiuiServices proxy initialized for MIUI service crash prevention on " + 
                    XiaomiDeviceDetector.getDeviceModel() + " (MIUI " + XiaomiDeviceDetector.getMiuiVersion() + ")");
        } else {
            Logger.d(TAG, "IXiaomiMiuiServices proxy initialized for MIUI service crash prevention");
        }
    }
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (message != null && message.contains("Attempt to invoke virtual method") && 
                    ...
                    Logger.w(TAG, "MIUI Camera Manager NullPointerException on Xiaomi, creating safe fallback: " + message);
                ...
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "MIUI Camera Manager UID mismatch on Xiaomi, creating safe fallback: " + message);
                    return createSafeMiuiCameraManagerForXiaomi();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in MIUI Camera Manager hook: " + e.getMessage());
    ...
    public static class MiuiForceDarkConfig extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in MIUI Force Dark Config hook: " + e.getMessage());
    ...
    public static class MiuiMonitorThread extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in MIUI Monitor Thread hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return null;
            }
        }
    ...
    public static class MiuiDownscaleImpl extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in MIUI Downscale Implementation hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return null;
            }
        }
    ...
    public static class ForceDarkHelperStubImpl extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in Force Dark Helper Stub Implementation hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return null;
            }
        }
    ...
    public static class HandWritingStubImpl extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in Hand Writing Stub Implementation hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return null;
            }
        }
    ...
    public static class OplusScrollToTopManager extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in Oplus Scroll To Top Manager hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return null;
            }
        }
    ...
    public static class OplusOverScrollerExtImpl extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in Oplus Over Scroller Extension Implementation hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return null;
            }
        }
    ...
    private static Object createSafeMiuiCameraManagerForXiaomi() {
        try {
            ...
            try {
                ...
                Logger.d(TAG, "Created safe MiuiCameraManager for Xiaomi using default constructor");
            } catch (Exception e) {
                Logger.w(TAG, "Could not create safe MiuiCameraManager for Xiaomi: " + e.getMessage());
                return null;
            }
            
            return miuiCameraManager;
        } catch (Exception e) {
            Logger.w(TAG, "Error creating safe MiuiCameraManager for Xiaomi: " + e.getMessage());
            return null;
        }
    }
}
