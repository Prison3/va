...
public class VPackageInfo implements Parcelable {
    ...
    public VPackageSettings mExtras;
    ...
    public VPackageInfo(PackageParser.Package aPackage) {
        ...
        // this.mExtras = new VPackageSettings((PackageSetting) aPackage.mExtras);
    ...
    protected VPackageInfo(Parcel in) {
        int N = in.readInt();
...
//        this.mExtras = in.readParcelable(VPackageSettings.class.getClassLoader());
    ...
    public final static class Activity extends Component<ActivityIntentInfo> {
        ...
        public Activity(Parcel parcel) {
            ...
            while (N-- > 0) {
                IntentInfo intentInfo = parcel.readParcelable(VPackageInfo.class.getClassLoader());
    ...
    public static class IntentInfo implements Parcelable {
        ...
        protected IntentInfo(Parcel in) {
            this.intentFilter = in.readParcelable(VPackageInfo.class.getClassLoader());
    ...
    public static class Component<II extends VPackageInfo.IntentInfo> {
        public VPackageInfo owner;
...
//        dest.writeParcelable(this.mExtras, flags);
    ...
    public static final Parcelable.Creator<VPackageInfo> CREATOR = new Parcelable.Creator<VPackageInfo>() {
        @Override
        public VPackageInfo createFromParcel(Parcel source) {
            return new VPackageInfo(source);
        }

        @Override
        public VPackageInfo[] newArray(int size) {
            return new VPackageInfo[size];
        }
    };
}
