...
public final class VUserHandle implements Parcelable {
     ...
     * @deprecated Consider using either {@link VUserHandle#USER_SYSTEM} constant or
     ...
     * @deprecated Consider using either {@link VUserHandle#SYSTEM} constant or
     * check the target user's flag {@link }.
     */
    @Deprecated
     ...
     */
    public static final VUserHandle SYSTEM = new VUserHandle(USER_SYSTEM);
     ...
     * @return A {@link VUserHandle} for that user.
     */
    public static VUserHandle getUserHandleForUid(int uid) {
    ...
    public static int getUserId(int uid) {
        if (MU_ENABLED) {
            ...
            return VUserHandle.USER_SYSTEM;
        }
    }
     ...
     * @hide
     */
    public static VUserHandle of(int userId) {
        return userId == USER_SYSTEM ? SYSTEM : new VUserHandle(userId);
    }
...
//    }
    ...
    public static int parseUserArg(String arg) {
        ...
        if ("all".equals(arg)) {
            ...
            userId = VUserHandle.USER_CURRENT;
        } else {
            try {
