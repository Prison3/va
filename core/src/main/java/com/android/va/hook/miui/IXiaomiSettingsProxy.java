...
public class IXiaomiSettingsProxy extends ClassInvocationStub {
    public static final String TAG = IXiaomiSettingsProxy.class.getSimpleName();
    ...
    protected void inject(Object base, Object proxy) {
        ...
        if (XiaomiDeviceDetector.isXiaomiDevice()) {
            Logger.d(TAG, "IXiaomiSettings proxy initialized for MIUI Settings UID mismatch prevention on " + 
                    XiaomiDeviceDetector.getDeviceModel() + " (MIUI " + XiaomiDeviceDetector.getMiuiVersion() + ")");
        } else {
            Logger.d(TAG, "IXiaomiSettings proxy initialized for MIUI Settings UID mismatch prevention");
        }
    }
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "Xiaomi UID mismatch in getStringForUser, returning safe default: " + message);
                    return getSafeDefaultForXiaomiSettings();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in Xiaomi getStringForUser hook: " + e.getMessage());
    ...
    public static class GetString extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                String message = e.getMessage();
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "Xiaomi UID mismatch in getString, returning safe default: " + message);
                    return getSafeDefaultForXiaomiSettings();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in Xiaomi getString hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return getSafeDefaultForXiaomiSettings();
            }
        }
    ...
    public static class GetIntForUser extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                String message = e.getMessage();
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "Xiaomi UID mismatch in getIntForUser, returning safe default: " + message);
                    return getSafeDefaultIntForXiaomiSettings();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in Xiaomi getIntForUser hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return getSafeDefaultIntForXiaomiSettings();
            }
        }
    ...
    public static class GetInt extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                String message = e.getMessage();
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "Xiaomi UID mismatch in getInt, returning safe default: " + message);
                    return getSafeDefaultIntForXiaomiSettings();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in Xiaomi getInt hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return getSafeDefaultIntForXiaomiSettings();
            }
        }
    ...
    public static class GlobalGetStringForUser extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                String message = e.getMessage();
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "Xiaomi UID mismatch in Global.getStringForUser, returning safe default: " + message);
                    return getSafeDefaultForXiaomiSettings();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in Xiaomi Global.getStringForUser hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return getSafeDefaultForXiaomiSettings();
            }
        }
    ...
    public static class GlobalGetString extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                String message = e.getMessage();
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "Xiaomi UID mismatch in Global.getString, returning safe default: " + message);
                    return getSafeDefaultForXiaomiSettings();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in Xiaomi Global.getString hook: " + e.getMessage());
                // Return safe default for Xiaomi devices
                return getSafeDefaultForXiaomiSettings();
            }
        }
