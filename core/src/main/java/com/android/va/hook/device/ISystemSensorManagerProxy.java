...
public class ISystemSensorManagerProxy extends ClassInvocationStub {
    public static final String TAG = ISystemSensorManagerProxy.class.getSimpleName();
    ...
    protected void inject(Object base, Object proxy) {
        ...
        Logger.d(TAG, "ISystemSensorManager proxy initialized for UID mismatch prevention");
    }
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "UID mismatch in SystemSensorManager constructor, creating safe fallback: " + message);
                    return createSafeSensorManager();
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in SystemSensorManager constructor hook: " + e.getMessage());
    ...
    public static class ParsePackageList extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in parsePackageList hook: " + e.getMessage());
    ...
    private static Object createSafeSensorManager() {
        try {
            ...
            try {
                ...
                Logger.d(TAG, "Created safe SystemSensorManager using default constructor");
            } catch (Exception e) {
                Logger.w(TAG, "Could not create safe SystemSensorManager: " + e.getMessage());
                return null;
            }
            
            return sensorManager;
        } catch (Exception e) {
            Logger.w(TAG, "Error creating safe SystemSensorManager: " + e.getMessage());
            return null;
        }
    }
}
