...
public class LevelDbProxy extends ClassInvocationStub {
    public static final String TAG = LevelDbProxy.class.getSimpleName();
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (message != null && message.contains("lock") && message.contains("Try again")) {
                    Logger.w(TAG, "LevelDB lock error detected, returning null: " + message);
                    // Return null to indicate database is unavailable
                    return null;
                } else if (message != null && message.contains("IO error")) {
                    Logger.w(TAG, "LevelDB IO error detected, returning null: " + message);
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (message != null && (message.contains("lock") || message.contains("IO error"))) {
                    Logger.w(TAG, "LevelDB native lock/IO error detected, returning null: " + message);
                    // Return null to indicate database is unavailable
                    return null;
                }
                throw e;
    ...
    public static class Get extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (who == null) {
                Logger.w(TAG, "LevelDB get called on null database, returning null");
                return null;
            }
            try {
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "LevelDB get error, returning null: " + e.getMessage());
                return null;
            }
        }
    }
    ...
    public static class Put extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (who == null) {
                Logger.w(TAG, "LevelDB put called on null database, returning false");
                return false;
            }
            try {
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "LevelDB put error, returning false: " + e.getMessage());
                return false;
            }
        }
    }
    ...
    public static class Delete extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            if (who == null) {
                Logger.w(TAG, "LevelDB delete called on null database, returning false");
                return false;
            }
            try {
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "LevelDB delete error, returning false: " + e.getMessage());
                return false;
            }
        }
    }
