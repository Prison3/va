...
public class Temu30200 {

    private static final String TAG = "Temu30200";
    ...
    public static void expressIntegrityWarmup() throws Throwable {
        ...
        while (true) {
            ...
            Class clsRequest = ReflectUtils.findClass("zk1.c$a", ActApp.classLoader());
            ...
            Class clsIntegrityManagerFactory = ReflectUtils.findClass("zk1.a", ActApp.classLoader());
    ...
    public static void piExpressRequest(String nonce, String cloudProjectNumber, Callback.C2<Boolean, String> callback) {
        try {
            ...
            Class clsRequest = ReflectUtils.findClass("zk1.c$d", ActApp.classLoader());
