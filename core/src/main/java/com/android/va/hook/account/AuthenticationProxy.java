...
public class AuthenticationProxy extends ClassInvocationStub {
    public static final String TAG = AuthenticationProxy.class.getSimpleName();
    ...
    public static class SignIn extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling signIn call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: SignIn error, returning success", e);
    ...
    public static class SignOut extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling signOut call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: SignOut error, returning success", e);
                return null;
            }
        }
    }
    ...
    public static class IsSignedIn extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling isSignedIn call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: IsSignedIn error, returning true", e);
                return true;
            }
        }
    }
    ...
    public static class GetCurrentUser extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling getCurrentUser call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: GetCurrentUser error, returning mock user", e);
    ...
    public static class GetAccessToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling getAccessToken call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: GetAccessToken error, returning mock token", e);
    ...
    public static class RefreshToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling refreshToken call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: RefreshToken error, returning mock token", e);
    ...
    public static class ValidateToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling validateToken call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: ValidateToken error, returning true", e);
                return true;
            }
        }
    }
    ...
    public static class Login extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling login call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: Login error, returning success", e);
    ...
    public static class Logout extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling logout call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: Logout error, returning success", e);
                return null;
            }
        }
    }
    ...
    public static class IsLoggedIn extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "Authentication: Handling isLoggedIn call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "Authentication: IsLoggedIn error, returning true", e);
                return true;
            }
        }
    }
    ...
    private static Object createMockSignInResult() {
        try {
            ...
            Logger.w(TAG, "Failed to create mock sign in result", e);
            return null;
        }
    }
    ...
    private static Object createMockLoginResult() {
        try {
            ...
            Logger.w(TAG, "Failed to create mock login result", e);
            return null;
        }
    }
    ...
    private static Object createMockUser() {
        try {
            ...
            Logger.w(TAG, "Failed to create mock user", e);
            return null;
        }
    }
}
