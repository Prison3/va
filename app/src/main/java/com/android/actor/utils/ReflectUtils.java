...
public class ReflectUtils {
    ...
    public static int getStaticIntField(Class cls, String fieldName) throws Throwable {
        return findField(cls, fieldName).getInt(null);
    }

    public static long getStaticLongField(Class cls, String fieldName) throws Throwable {
        return findField(cls, fieldName).getLong(null);
    }
    ...
    public static double getDoubleField(Object obj, String fieldName) throws Throwable {
    ...
    public static void setStaticIntField(Class cls, String fieldName, int value) throws Throwable {
        findField(cls, fieldName).setInt(null, value);
    }

    public static void setLongField(Object obj, String fieldName, long value) throws Throwable {
        findField(obj.getClass(), fieldName).setLong(obj, value);
    }

    public static void setStaticLongField(Class cls, String fieldName, long value) throws Throwable {
        findField(cls, fieldName).setLong(null, value);
    }

    public static void setFloatField(Object obj, String fieldName, float value) throws Throwable {
    ...
    public static Constructor getConstructorWithParameterCount(Class cls, int count) {
