...
public class AndroidIdProxy extends ClassInvocationStub {
    public static final String TAG = AndroidIdProxy.class.getSimpleName();
    ...
    public static class GetAndroidId extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "AndroidId: Handling getAndroidId call");
                Object result = method.invoke(who, args);
                if (result == null || "0".equals(result.toString()) || "".equals(result.toString())) {
                    Logger.w(TAG, "AndroidId: Invalid Android ID detected, returning mock ID");
                    return generateMockAndroidId();
                }
                return result;
            } catch (Exception e) {
                Logger.w(TAG, "AndroidId: GetAndroidId error, returning mock ID", e);
                return generateMockAndroidId();
            }
        }
    }
    ...
    public static class GetString extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "AndroidId: Handling getString call");
                Object result = method.invoke(who, args);
                ...
                if (args != null && args.length > 0 && args[0] instanceof String) {
                    ...
                    if (key.contains("android_id") || key.contains("ANDROID_ID") || 
                        ...
                        if (result == null || "0".equals(result.toString()) || "".equals(result.toString())) {
                            Logger.w(TAG, "AndroidId: Invalid Android ID string detected, returning mock ID");
                            return generateMockAndroidId();
                        }
                    }
                }
                ...
                Logger.w(TAG, "AndroidId: GetString error, returning original result", e);
    ...
    public static class GetLong extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "AndroidId: Handling getLong call");
                Object result = method.invoke(who, args);
                ...
                if (args != null && args.length > 0 && args[0] instanceof String) {
                    ...
                    if (key.contains("android_id") || key.contains("ANDROID_ID") || 
                        ...
                        if (result == null || ((Number) result).longValue() == 0) {
                            Logger.w(TAG, "AndroidId: Invalid Android ID long detected, returning mock ID");
                ...
                Logger.w(TAG, "AndroidId: GetLong error, returning original result", e);
                return method.invoke(who, args);
            }
        }
    }
    ...
    public static class Get extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "AndroidId: Handling get call");
                Object result = method.invoke(who, args);
                ...
                if (args != null && args.length > 0 && args[0] instanceof String) {
                    ...
                    if (key.contains("android_id") || key.contains("ANDROID_ID") || 
                        key.contains("secure_id") || key.contains("device_id")) {
                        if (result == null || "0".equals(result.toString()) || "".equals(result.toString())) {
                            Logger.w(TAG, "AndroidId: Invalid Android ID get detected, returning mock ID");
                            return generateMockAndroidId();
                        }
                    }
                }
                ...
                Logger.w(TAG, "AndroidId: Get error, returning original result", e);
                return method.invoke(who, args);
            }
        }
    }
    ...
    public static class Read extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "AndroidId: Handling read call");
                Object result = method.invoke(who, args);
                ...
                if (args != null && args.length > 0 && args[0] instanceof String) {
                    ...
                    if (key.contains("android_id") || key.contains("ANDROID_ID") || 
                        key.contains("secure_id") || key.contains("device_id")) {
                        if (result == null || "0".equals(result.toString()) || "".equals(result.toString())) {
                            Logger.w(TAG, "AndroidId: Invalid Android ID read detected, returning mock ID");
                            return generateMockAndroidId();
                        }
                    }
                }
                ...
                Logger.w(TAG, "AndroidId: Read error, returning original result", e);
                return method.invoke(who, args);
            }
        }
    }
    ...
    private static String generateMockAndroidId() {
        ...
        Logger.d(TAG, "AndroidId: Generated mock Android ID: " + mockId);
        return mockId;
    }
    ...
    private static Long generateMockAndroidIdLong() {
        ...
        Logger.d(TAG, "AndroidId: Generated mock Android ID long: " + mockId);
        return mockId;
    }
}
