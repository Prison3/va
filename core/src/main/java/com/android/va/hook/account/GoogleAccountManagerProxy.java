...
public class GoogleAccountManagerProxy extends ClassInvocationStub {
    public static final String TAG = GoogleAccountManagerProxy.class.getSimpleName();
    ...
    protected Object getWho() {
        try {
            ...
            Logger.w(TAG, "Failed to get AccountManager instance", e);
        }
        return null;
    }
    ...
    public static class GetAccounts extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling getAccounts call");
                ...
                if (result != null && result instanceof Account[]) {
                    ...
                    if (accounts.length > 0) {
                        Logger.d(TAG, "GoogleAccountManager: Found " + accounts.length + " real accounts");
                        return result;
                    }
                }
                
                // Return mock Google account if no real accounts found
                Logger.d(TAG, "GoogleAccountManager: No real accounts found, returning mock account");
                return createMockGoogleAccounts();
                
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: GetAccounts error, returning mock accounts", e);
                return createMockGoogleAccounts();
            }
        }
    }
    ...
    public static class GetAccountsByType extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling getAccountsByType call");
                
                if (args != null && args.length > 0) {
                    String accountType = (String) args[0];
                    Logger.d(TAG, "GoogleAccountManager: Requesting accounts of type: " + accountType);
                    
                    // For Google accounts, return mock accounts
                    if ("com.google".equals(accountType)) {
                        Logger.d(TAG, "GoogleAccountManager: Returning mock Google accounts");
                        return createMockGoogleAccounts();
                    }
                }
                ...
                Logger.w(TAG, "GoogleAccountManager: GetAccountsByType error, returning mock accounts", e);
                return createMockGoogleAccounts();
            }
        }
    }
    ...
    public static class GetPassword extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling getPassword call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: GetPassword error, returning mock password", e);
    ...
    public static class GetUserData extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling getUserData call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: GetUserData error, returning mock data", e);
    ...
    public static class AddAccount extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling addAccount call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: AddAccount error, returning mock result", e);
    ...
    public static class RemoveAccount extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling removeAccount call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: RemoveAccount error, returning true", e);
    ...
    public static class HasFeatures extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling hasFeatures call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: HasFeatures error, returning true", e);
    ...
    public static class GetAuthToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling getAuthToken call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: GetAuthToken error, returning mock token", e);
    ...
    public static class InvalidateAuthToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling invalidateAuthToken call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: InvalidateAuthToken error, ignoring", e);
                return null;
            }
        }
    }
    ...
    public static class PeekAuthToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling peekAuthToken call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: PeekAuthToken error, returning mock token", e);
    ...
    public static class SetPassword extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling setPassword call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: SetPassword error, ignoring", e);
                return null;
            }
        }
    }
    ...
    public static class SetUserData extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling setUserData call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: SetUserData error, ignoring", e);
                return null;
            }
        }
    }
    ...
    public static class GetAuthenticatorTypes extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling getAuthenticatorTypes call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: GetAuthenticatorTypes error, returning mock types", e);
    ...
    public static class IsAccountPresent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling isAccountPresent call");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: IsAccountPresent error, returning true", e);
    ...
    public static class GetUserDataByKey extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                Logger.d(TAG, "GoogleAccountManager: Handling getUserData call with key");
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.w(TAG, "GoogleAccountManager: GetUserData error, returning mock data", e);
    ...
    private static Account[] createMockGoogleAccounts() {
        try {
            ...
            Logger.d(TAG, "GoogleAccountManager: Created " + accounts.size() + " mock Google accounts");
            return accounts.toArray(new Account[0]);
            
        } catch (Exception e) {
            Logger.e(TAG, "GoogleAccountManager: Failed to create mock accounts", e);
    ...
    private static boolean isGoogleApp() {
        try {
            ...
            Logger.w(TAG, "Failed to check if current package is Google app", e);
        }
        return false;
    }
}
