...
import com.android.reflection.BlackReflectionInfo;
import com.android.reflection.utils.ClassUtils;
...
public class BlackReflectionProxy {
    ...
    private static final ClassName BR = ClassName.get("com.android.reflection", "BlackReflection");
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return com.android.reflection.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
