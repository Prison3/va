...
public class IContentProviderProxy extends ClassInvocationStub {
    ...
    protected void inject(Object base, Object proxy) {
        ...
        Logger.d(TAG, "IContentProvider proxy initialized for UID mismatch prevention");
    }
    ...
    public static class Insert extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in insert hook: " + e.getMessage());
    ...
    public static class Update extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in update hook: " + e.getMessage());
    ...
    public static class Delete extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                Logger.w(TAG, "Error in delete hook: " + e.getMessage());
                // Return 0 to prevent crashes
                return 0;
            }
        }
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (message != null && message.contains("Calling uid") && message.contains("doesn't match source uid")) {
                    Logger.w(TAG, "UID mismatch in call method, returning safe default: " + message);
                    return null; // Return null to prevent crashes
                }
                throw e;
            } catch (Exception e) {
                Logger.w(TAG, "Error in call hook: " + e.getMessage());
