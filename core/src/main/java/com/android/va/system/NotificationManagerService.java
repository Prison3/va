...
import com.android.va.mirror.android.app.BRNotificationChannel;
import com.android.va.mirror.android.app.BRNotificationChannelGroup;
import com.android.va.mirror.android.app.BRNotificationO;
...
/**
 * Created by Prison on 2022/3/15.
 */
public class NotificationManagerService extends INotificationManagerService.Stub implements ISystemService {
    private final static NotificationManagerService sService = new NotificationManagerService();
    ...
    public void enqueueNotificationWithTag(int id, String tag, Notification notification, int userId) {
        ProcessRecord processByPid = ProcessManagerService.get().findProcessByPid(Binder.getCallingPid());
        if (processByPid == null)
            return;
