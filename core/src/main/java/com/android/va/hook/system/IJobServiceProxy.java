...
import com.android.va.mirror.android.app.job.BRIJobSchedulerStub;
import com.android.va.mirror.android.os.BRServiceManager;
import com.android.va.runtime.VJobManager;
...
import com.android.va.utils.UIDSpoofingHelper;
...
public class IJobServiceProxy extends BinderInvocationStub {
    public static final String TAG = IJobServiceProxy.class.getSimpleName();
    ...
    public static class Schedule extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (args == null || args.length == 0) {
                    Logger.w(TAG, "Schedule: No arguments provided, returning RESULT_FAILURE");
                    return 0; // RESULT_FAILURE
                }
                
                if (args[0] == null) {
                    Logger.w(TAG, "Schedule: args[0] is null, returning RESULT_FAILURE");
                    return 0; // RESULT_FAILURE
                }
                
                if (!(args[0] instanceof JobInfo)) {
                    Logger.w(TAG, "Schedule: args[0] is not JobInfo: " + args[0].getClass().getSimpleName());
                ...
                try {
                    ...
                    if (proxyJobInfo != null) {
                        args[0] = proxyJobInfo;
                        Logger.d(TAG, "Schedule: Successfully created proxy JobInfo");
                ...
                Logger.e(TAG, "Schedule: Error processing job", e);
                
                // Handle specific UID validation errors
                if (isUIDValidationError(e)) {
                    Logger.w(TAG, "UID validation failed for job scheduling, returning RESULT_FAILURE: " + e.getCause().getMessage());
                ...
                try {
                    ...
                    Logger.e(TAG, "Schedule: Fallback also failed", fallbackException);
                    return 0; // RESULT_FAILURE
                }
            }
        }
        ...
        private Object handleNonJobInfoSchedule(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (args[0] instanceof String) {
                    ...
                    Logger.d(TAG, "Schedule: Handling WorkManager string ID: " + workId);
                ...
                Logger.w(TAG, "Schedule: Failed to handle non-JobInfo schedule", e);
                return 0; // RESULT_FAILURE
            }
        }
        ...
        private Object scheduleWithUIDSpoofing(Object who, Method method, Object[] args, JobInfo jobInfo) throws Throwable {
            try {
                ...
                Logger.d(TAG, "Schedule: Attempting UID spoofing for package: " + targetPackage);
                ...
                if (UIDSpoofingHelper.needsUIDSpoofing("job_schedule", targetPackage)) {
                    Logger.d(TAG, "Schedule: UID spoofing needed, attempting to bypass validation");
                    ...
                    Logger.w(TAG, "Schedule: UID spoofing not fully implemented, returning RESULT_FAILURE");
                    return 0; // RESULT_FAILURE
                } else {
                    Logger.d(TAG, "Schedule: No UID spoofing needed, proceeding normally");
                    return method.invoke(who, args);
                }
                
            } catch (Exception e) {
                Logger.w(TAG, "Schedule: UID spoofing failed", e);
                return 0; // RESULT_FAILURE
            }
        }
        ...
        private JobInfo createMinimalJobInfo(String workId) {
            try {
                ...
                Logger.d(TAG, "Schedule: Creating minimal JobInfo for work ID: " + workId);
                return null; // Placeholder - would need proper JobInfo.Builder implementation
            } catch (Exception e) {
                Logger.w(TAG, "Schedule: Failed to create minimal JobInfo", e);
                return null;
            }
        }
    ...
    public static class Cancel extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (jobId == null) {
                    Logger.w(TAG, "Cancel: JobId is null");
                    return method.invoke(who, args);
                }
                
                args[0] = VJobManager.get()
                        .cancel(VActivityThread.getAppConfig().processName, jobId);
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.e(TAG, "Cancel: Error canceling job", e);
                return method.invoke(who, args);
            }
        }
    }
    ...
    public static class CancelAll extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                VJobManager.get().cancelAll(VActivityThread.getAppConfig().processName);
                return method.invoke(who, args);
            } catch (Exception e) {
                Logger.e(TAG, "CancelAll: Error canceling all jobs", e);
                return method.invoke(who, args);
            }
        }
    }
    ...
    public static class Enqueue extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                // Check if args[0] is actually a JobInfo object
                if (args == null || args.length == 0) {
                    Logger.w(TAG, "Enqueue: No arguments provided, returning RESULT_FAILURE");
                    return 0; // RESULT_FAILURE
                }
                
                if (args[0] == null) {
                    Logger.w(TAG, "Enqueue: args[0] is null, returning RESULT_FAILURE");
                    return 0; // RESULT_FAILURE
                }
                
                if (!(args[0] instanceof JobInfo)) {
                    Logger.w(TAG, "Enqueue: args[0] is not JobInfo: " + args[0].getClass().getSimpleName());
                    // For non-JobInfo objects, try to handle them gracefully
                ...
                try {
                    ...
                    if (proxyJobInfo != null) {
                        args[0] = proxyJobInfo;
                        Logger.d(TAG, "Enqueue: Successfully created proxy JobInfo");
                        return method.invoke(who, args);
                    }
                } catch (Exception e) {
                ...
                Logger.e(TAG, "Enqueue: Error processing job", e);
                
                // Handle specific UID validation errors
                if (isUIDValidationError(e)) {
                    Logger.w(TAG, "UID validation failed for job enqueuing, returning RESULT_FAILURE: " + e.getCause().getMessage());
                    return 0; // RESULT_FAILURE - don't retry with same UID
                }
                ...
                try {
                    ...
                    Logger.e(TAG, "Enqueue: Fallback also failed", fallbackException);
                    return 0; // RESULT_FAILURE
                }
            }
        }
        ...
        private Object handleNonJobInfoEnqueue(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                if (args[0] instanceof String) {
                    String workId = (String) args[0];
                    Logger.d(TAG, "Enqueue: Handling WorkManager string ID: " + workId);
                ...
                Logger.w(TAG, "Enqueue: Failed to handle non-JobInfo enqueue", e);
                return 0; // RESULT_FAILURE
            }
        }
        ...
        private Object enqueueWithUIDSpoofing(Object who, Method method, Object[] args, JobInfo jobInfo) throws Throwable {
            try {
                // Get the target package name from the JobInfo
                String targetPackage = jobInfo.getService().getPackageName();
                Logger.d(TAG, "Enqueue: Attempting UID spoofing for package: " + targetPackage);
                ...
                if (UIDSpoofingHelper.needsUIDSpoofing("job_enqueue", targetPackage)) {
                    Logger.d(TAG, "Enqueue: UID spoofing needed, attempting to bypass validation");
                    
                    // For now, we'll return failure but log the attempt
                    // In a full implementation, you'd need to actually spoof the UID at the system level
                    Logger.w(TAG, "Enqueue: UID spoofing not fully implemented, returning RESULT_FAILURE");
                    return 0; // RESULT_FAILURE
                } else {
                    Logger.d(TAG, "Enqueue: No UID spoofing needed, proceeding normally");
                    return method.invoke(who, args);
                }
                
            } catch (Exception e) {
                Logger.w(TAG, "Enqueue: UID spoofing failed", e);
                return 0; // RESULT_FAILURE
            }
        }
        ...
        private JobInfo createMinimalJobInfo(String workId) {
            try {
                // This is a simplified approach - in practice, you'd need to create a proper JobInfo
                // For now, we'll return null to indicate failure
                Logger.d(TAG, "Enqueue: Creating minimal JobInfo for work ID: " + workId);
                return null; // Placeholder - would need proper JobInfo.Builder implementation
            } catch (Exception e) {
                Logger.w(TAG, "Enqueue: Failed to create minimal JobInfo", e);
                return null;
            }
        }
