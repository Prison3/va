...
public class VPackageManager extends Manager<IPackageManagerService> {
     ...
     */
    public IPackageManagerService getServiceWithFallback() {
        IPackageManagerService service = getService();
        if (service == null) {
    ...
    public ApplicationInfo getApplicationInfo(String packageName, int flags, int userId) {
        try {
            IPackageManagerService service = getServiceWithFallback();
            if (service == null) {
    ...
    private boolean isInstalledFallback(String packageName) {
        try {
            ...
            if (packageName != null && (packageName.equals("com.media.bestrecorder.audiorecorder") || 
                                       packageName.startsWith("com.android.va"))) {
    ...
    public String[] getPackagesForUid(int uid) {
        try {
            return getService().getPackagesForUid(uid, VActivityThread.getUserId());
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        return new String[]{};
