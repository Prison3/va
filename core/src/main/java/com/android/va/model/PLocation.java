...
/*
 * created by Prisoning at 2022/03/05
 * */
...
//    private float mBearingAccuracyDegrees = 0.0f;
    ...
    public PLocation(double latitude, double mLongitude) {
    ...
    public static final Parcelable.Creator<PLocation> CREATOR = new Parcelable.Creator<PLocation>() {
        @Override
